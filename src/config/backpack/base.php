...
return [
    ...
    */
    ...
    'middleware_class' => [
        ...
        \hlyall01\Backpack\CRUD\app\Http\Middleware\AuthenticateSession::class,
        // \hlyall01\Backpack\CRUD\app\Http\Middleware\UseBackpackAuthGuardInsteadOfDefaultAuthGuard::class,
    ],
